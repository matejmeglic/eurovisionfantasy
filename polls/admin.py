...
class QuestionAdmin(admin.ModelAdmin):
    ...
    list_display = ("id", "question", "question_type", "question_values", "question_grade_description", "max_choices", "question_grade", "question_grade_partials", "question_grade_range")
